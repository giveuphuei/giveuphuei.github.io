...
Calendar.prototype.style = function(){
    ...
    strStyle += ".calendar ul {list-style-type:none; margin:0; padding:0;vertical-align:middle;height:90px;}";
    ...
    strStyle += ".calendar .month li{float:left;width:24.8%;height:30px;line-height:30px;text-align:center;background-color:#EDF3F9;}";
    ...
    strStyle += ".today{ display: inline-block!important;width: 100%!important;height:100%!important; background-color:#ffffaa!important;}";
...
Calendar.prototype.valueSelected = function(date){
    // 选择值
    console.log('hx-calendar.js--选择的月份为',this.dateControl.value )
